...
public class PanelListaLearningEst extends JPanel implements ListSelectionListener{
	
	 private JList<LearningPath> listaDeLearnings;
	 private DefaultListModel<LearningPath> dataModel;
	 private VentanaPrincipalAlumno ventanaPrincipal;
	
	 public PanelListaLearningEst( VentanaPrincipalAlumno ventanaPrincipal )
	    {
